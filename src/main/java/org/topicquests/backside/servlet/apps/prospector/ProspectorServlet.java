 ...
 */
public class ProspectorServlet extends HttpServlet {
	private ServletEnvironment environment;
	private ProspectorHandler handler;
    
	public ProspectorServlet(ServletEnvironment env, String basePath) {
		environment = env;
		handler = new ProspectorHandler(environment,basePath);
	}
