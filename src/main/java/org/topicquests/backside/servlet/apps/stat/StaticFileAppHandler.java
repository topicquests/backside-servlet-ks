 ...
 *
 */
public class StaticFileAppHandler  extends BaseHandler {

	/**
	 * 
	 */
	public StaticFileAppHandler(ServletEnvironment env, String basePath) {
		super(env,basePath);
	}
	...
	public void handleGet(HttpServletRequest request, HttpServletResponse response, ITicket credentials, JSONObject jsonObject) throws ServletException, IOException {
		System.out.println("Static "+super.getPath(request));
